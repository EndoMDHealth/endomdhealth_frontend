...
const MedicalConsult = () => {
  ...
  const steps = [
    {
      ...
      description:
        "We take most major insurance plans that help with the cost of a consult. Out-of-network patients can select direct pay",
    },
    {
      icon: FileText,
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "As soon as you finish your medical questionnaire and obtain the required labs, our team will send you options to schedule your video visit with your doctor. Our goal is to get your child scheduled within 1-2 business days.",
    },
    {
      question: "Can I get a second opinion through EndoMD Health?",
      answer:
        "Yes, we provide second opinions and would be happy to look at your child's past medical history, labs and other relevant medical information to diagnose and treat their hormone problem. Our goal is that you are completely satisfied and confident in your child's diagnosis and treatment plan.",
    },
  ];
              ...
              return (
                <div key={index} className="flex gap-6 items-start">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-18 h-15 rounded-full bg-[hsl(var(--accent))] flex items-center justify-center">
